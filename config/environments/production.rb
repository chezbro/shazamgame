Rails.application.configure do
  ...
  # Rails.application.routes.default_url_options[:host] = 'shazam13.herokuapp.com'
...
config.action_mailer.default_url_options = { :host => 'http://shazam13.com' }
...
config.action_mailer.smtp_settings = {
    ...
    :port => 587,
    :domain => 'shazam13.com',
    :user_name => ENV['GMAIL_USERNAME'] || "shazam13app@gmail.com",
